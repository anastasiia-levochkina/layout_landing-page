...
document.addEventListener("click", (evt)=>{
    ...
    if (menu.classList.contains("active") && !clickInsideMenu && !clickOnMenuButton) closeMenu();
});
...
if (contactForm && sendBtn && successMessage) contactForm.addEventListener("submit", (evt)=>{
    evt.preventDefault();
